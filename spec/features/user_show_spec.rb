...
RSpec.feature 'User Show Page', type: :feature do
  before(:each) do
    @user = User.create(name: 'Ali', photo: 'https://placehold.co/200x133', bio: 'He is good programmer', post_counter: 0)
